...
/* ────────────────────────────────────────
   Project05.jsx — Where Do We Go From Here
   ──────────────────────────────────────── */
  ...
  return (
    <div
      style={{
        ...
        aspectRatio: "4 / 3",
        borderRadius: "0.5rem",
        background: "linear-gradient(135deg, #4f46c215, #4f46c208)",
        border: "1px dashed #4f46c230",
        display: "flex",
        alignItems: "center",
...
export default function Project05() {
  return (
    <ProjectsLayout slug="where-do-we-go-from-here">
