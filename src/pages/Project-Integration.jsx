...
/* ───────────────────────────────────────────────────
   Project02.jsx — What Seamless Integration Looks Like
   ─────────────────────────────────────────────────── */
  ...
  return (
    <div
      style={{
        ...
        aspectRatio: "4 / 3",
        borderRadius: "0.5rem",
        background: "linear-gradient(135deg, #ea782415, #ea782408)",
        border: "1px dashed #ea782430",
        display: "flex",
        alignItems: "center",
...
export default function Project02() {
  return (
    <ProjectsLayout slug="what-seamless-integration-looks-like">
